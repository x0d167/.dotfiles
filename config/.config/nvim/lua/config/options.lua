...
-- opt.colorcolumn = "+1" -- Adds a visual bar indicating 'textwidth'
opt.cursorline = true -- Enable highlighting of the current line
opt.expandtab = true -- Use spaces instead of tabs
opt.fileencoding = "utf-8" -- The encoding written to a file (default: 'utf-e')
opt.fillchars = {
  foldopen = "",
  foldclose = "",
  fold = " ",
...
opt.textwidth = 95 -- Setting the text with for wrapping and formatting text
